<template>
	<div class="contenido">
		<div class="row">
			...
			<button type="button" class="btn btn-success btnadd ml-3 mt-1" data-toggle="modal" data-target=".bd-example-modal-xl" circle @click="abrirModal">
				<i class="fa fa-plus"></i>
			</button>
		</div>
		<div class="row justify-content-center">
			<div class="card my-2 mx-4" :style="`background-image: url(${categoria.photo});background-position-x: center; background-position-y: center; background-repeat: no-repeat; width: 18rem; height: 15rem`" v-for="categoria in categoria_platos" title="click">
				<div class="card-tittle text-center text-capitalize mt-2">
					<input class="form-control border-0 text-center" :style="`text-decoration: underline overline wavy ${categoria.color}; 
					font-family: cursive;`" v-model="categoria.name">
				</div>
				<div class="card-body">
					<el-input
					type="textarea"
				...
				<button type="button" class="btn btn-danger btnadd" title="Eliminar" @click="eliminar(categoria)">
		...
		<!-- Modal -->
		<div id="registerDishesCategory" class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
