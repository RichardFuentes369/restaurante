	...
	<div class="contenido"> 
		...
		<div class="justify-content-center table-responsive">
			<table class="table table-striped">
				...
				<tbody>
					<tr class="contenido" v-for="(restaurante, key) in restaurantes">
						<th scope="row">1</th>
						<td>Mark</td>
						<td>Otto</td>
						<td>@mdo</td>
						...
						<td>Otto</td>
						<td>
							<button type="button" class="btn btn-success btnadd ml-3" data-toggle="modal" data-target=".bd-example-modal-xl" circle>
				...
				<div class="modal-content">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">Añadir Restaurante</h5>
